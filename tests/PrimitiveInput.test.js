...
import { StringInput, IntegerInput, FloatInput,
  BooleanInput, EnumInput } from 'src/PrimitiveInput';
import { fuzz, getInput, setInput, isEmpty,
  setTarget, makeInput } from './utils';
...
// TODO docs
const getSelected = w => w.find('option').map(e => e.instance().selected).filter(Boolean)
