...
import { StringOutput, BooleanOutput, EnumOutput,
  IntegerOutput, FloatOutput } from 'src/PrimitiveOutput';
...
describe('EnumOutput', () => {
  const wrapper = shallow(<EnumOutput data={{
      a: false,
      b: true,
      c: true
    }} />);
  ...
  it('displays enum', () => 
    expect(wrapper.contains(<select multiple disabled>
